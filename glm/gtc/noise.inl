...
namespace gtc
{
	...
	GLM_FUNC_QUALIFIER tvec4<T, P> grad4(__thread__ T const & j, __thread__ tvec4<T, P> const & ip)
	{
	...
	template <typename T, precision P>
	GLM_FUNC_QUALIFIER T perlin(__thread__ tvec2<T, P> const & Position)
	{
	...
	// Classic Perlin noise
	template <typename T, precision P>
	GLM_FUNC_QUALIFIER T perlin(__thread__ tvec3<T, P> const & Position)
	{
	...
	// Classic Perlin noise
	template <typename T, precision P>
	GLM_FUNC_QUALIFIER T perlin(__thread__ tvec3<T, P> const & P)
	{
	...
	*/
	// Classic Perlin noise
	template <typename T, precision P>
	GLM_FUNC_QUALIFIER T perlin(__thread__ tvec4<T, P> const & Position)
	{
	...
	template <typename T, precision P>
	GLM_FUNC_QUALIFIER T perlin(__thread__ tvec2<T, P> const & Position, __thread__ tvec2<T, P> const & rep)
	{
	...
	// Classic Perlin noise, periodic variant
	template <typename T, precision P>
	GLM_FUNC_QUALIFIER T perlin(__thread__ tvec3<T, P> const & Position, __thread__ tvec3<T, P> const & rep)
	{
	...
	template <typename T, precision P>
	GLM_FUNC_QUALIFIER T perlin(__thread__ tvec4<T, P> const & Position, __thread__ tvec4<T, P> const & rep)
	{
	...
	template <typename T, precision P>
	GLM_FUNC_QUALIFIER T simplex(__thread__ glm::tvec2<T, P> const & v)
	{
	...
	template <typename T, precision P>
	GLM_FUNC_QUALIFIER T simplex(__thread__ tvec3<T, P> const & v)
	{
	...
	template <typename T, precision P>
	GLM_FUNC_QUALIFIER T simplex(__thread__ tvec4<T, P> const & v)
	{
		tvec4<T, P> const C(
