...
namespace detail
{
	...
	{
		GLM_FUNC_QUALIFIER static vecType<T, P> call(__thread__ vecType<T, P> const& ColorRGB, T GammaCorrection)
		{
	...
	{
		GLM_FUNC_QUALIFIER static tvec4<T, P> call(__thread__ tvec4<T, P> const& ColorRGB, T GammaCorrection)
		{
	...
	{
		GLM_FUNC_QUALIFIER static vecType<T, P> call(__thread__ vecType<T, P> const& ColorSRGB, T Gamma)
		{
			return mix(
	...
	{
		GLM_FUNC_QUALIFIER static tvec4<T, P> call(__thread__ tvec4<T, P> const& ColorSRGB, T Gamma)
		{
	...
	template <typename T, precision P, template <typename, precision> class vecType>
	GLM_FUNC_QUALIFIER vecType<T, P> convertLinearToSRGB(__thread__ vecType<T, P> const& ColorLinear)
	{
		return detail::compute_rgbToSrgb<T, P, vecType>::call(ColorLinear, static_cast<T>(0.41666));
	}

	template <typename T, precision P, template <typename, precision> class vecType>
	GLM_FUNC_QUALIFIER vecType<T, P> convertLinearToSRGB(__thread__ vecType<T, P> const& ColorLinear, T Gamma)
	{
		return detail::compute_rgbToSrgb<T, P, vecType>::call(ColorLinear, static_cast<T>(1) / Gamma);
	}

	template <typename T, precision P, template <typename, precision> class vecType>
	GLM_FUNC_QUALIFIER vecType<T, P> convertSRGBToLinear(__thread__ vecType<T, P> const& ColorSRGB)
	{
		return detail::compute_srgbToRgb<T, P, vecType>::call(ColorSRGB, static_cast<T>(2.4));
	}
	
	template <typename T, precision P, template <typename, precision> class vecType>
	GLM_FUNC_QUALIFIER vecType<T, P> convertSRGBToLinear(__thread__ vecType<T, P> const& ColorSRGB, T Gamma)
	{
