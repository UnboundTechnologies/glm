...
namespace detail
{
	...
	GLM_FUNC_QUALIFIER vecIUType<T, P> mask(__thread__ vecIUType<T, P> const& v)
	{
	...
	GLM_FUNC_QUALIFIER vecType<T, P> bitfieldRotateRight(__thread__ vecType<T, P> const & In, int Shift)
	{
	...
	template <typename T, precision P, template <typename, precision> class vecType>
	GLM_FUNC_QUALIFIER vecType<T, P> bitfieldRotateLeft(__thread__ vecType<T, P> const& In, int Shift)
	{
	...
	template <typename T, precision P, template <typename, precision> class vecType>
	GLM_FUNC_QUALIFIER vecType<T, P> bitfieldFillOne(__thread__ vecType<T, P> const& Value, int FirstBit, int BitCount)
	{
	...
	template <typename T, precision P, template <typename, precision> class vecType>
	GLM_FUNC_QUALIFIER vecType<T, P> bitfieldFillZero(__thread__ vecType<T, P> const& Value, int FirstBit, int BitCount)
	{
		return Value & static_cast<T>(~(mask(BitCount) << FirstBit));
	}
