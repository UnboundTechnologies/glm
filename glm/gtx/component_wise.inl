...
namespace detail
{
	...
	{
		GLM_FUNC_QUALIFIER static vecType<floatType, P> call(__thread__ vecType<T, P> const & v)
		{
	...
	{
		GLM_FUNC_QUALIFIER static vecType<T, P> call(__thread__ vecType<floatType, P> const & v)
		{
	...
	GLM_FUNC_QUALIFIER vecType<floatType, P> compNormalize(__thread__ vecType<T, P> const & v)
	{
	...
	template <typename T, typename floatType, precision P, template <typename, precision> class vecType>
	GLM_FUNC_QUALIFIER vecType<T, P> compScale(__thread__ vecType<floatType, P> const & v)
	{
	...
	GLM_FUNC_QUALIFIER T compAdd(__thread__ vecType<T, P> const & v)
	{
		T Result(0);
	...
	template <typename T, precision P, template <typename, precision> class vecType>
	GLM_FUNC_QUALIFIER T compMul(__thread__ vecType<T, P> const & v)
	{
		T Result(1);
		for(length_t i = 0, n = v.length(); i < n; ++i)
			Result *= v[i];
	...
	template <typename T, precision P, template <typename, precision> class vecType>
	GLM_FUNC_QUALIFIER T compMin(__thread__ vecType<T, P> const & v)
	{
		T Result(v[0]);
	...
	template <typename T, precision P, template <typename, precision> class vecType>
	GLM_FUNC_QUALIFIER T compMax(__thread__ vecType<T, P> const & v)
	{
		T Result(v[0]);
		for(length_t i = 1, n = v.length(); i < n; ++i)
